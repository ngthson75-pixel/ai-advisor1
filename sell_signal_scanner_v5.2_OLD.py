...
def push_sell_signal(sell_signal, api_url):
    ...
    # Map V5.2 exit reasons → Frontend-compatible strategy codes
    STRATEGY_MAP = {
    ...
    payload = {
        ...
        'action': 'SELL',
        'strategy': frontend_strategy,  # ← Frontend-compatible code
        ...
        'note': f"{exit_reason} ({exit_pct}%)",  # ← Store detailed reason in note
    }
