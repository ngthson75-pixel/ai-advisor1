#!/usr/bin/env python3
"""
Copy Signals Data from Production to Staging
"""
...
# Production (Render PostgreSQL) - SSL required
PRODUCTION_DB = "postgresql://ai_advisor_user:OPmx1O1UTpXkn1XvlFKZPDPbAZlCx1TJ@dpg-ctg0nllds78s73a9h880-a.oregon-postgres.render.com/ai_advisor_db?sslmode=require"

# Staging (Supabase PostgreSQL) - SSL required
STAGING_DB = "postgresql://postgres.xyzxaxajshlowpkiouon:3NfbmvjGThaS2l2L@aws-1-ap-southeast-2.pooler.supabase.com:5432/postgres?sslmode=require"
...
def copy_signals():
    ...
    with psycopg.connect(PRODUCTION_DB) as prod_conn, \
         psycopg.connect(STAGING_DB) as staging_conn:
