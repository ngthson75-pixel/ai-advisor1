...
export default function LandingPage({ onLogin }) {
  ...
  const [isVipLogin, setIsVipLogin] = useState(false)
  ...
  const handleVipLogin = async (e) => {
    e.preventDefault()
    setVipLoading(true)
    setVipError('')
    try {
      const res = await fetch(`${VIP_API}/api/auth/login`, {
        method: 'POST',
      ...
      if (!res.ok || !data.success) {
        setVipError(data.error || 'Email hoặc mật khẩu không đúng')
        setVipLoading(false)
        return
      }
      const userData = {
      ...
      setVipError('Không kết nối được server. Thử lại sau.')
    }
    setVipLoading(false)
  }
                    ...
                    <div style={{
                      ...
                      <div>
                        ...
                        <div style={{
                          ...
                          {marketRisk.market_mode === 'BULL' ? '🟢' : marketRisk.market_mode === 'BEAR' ? 'ðŸ"´' : '🟡'}{' '}
      ...
      <section className="features">
        <div className="container">
          <div className="section-header">
            ...
            <p>Công nghệ AI tiên tiến giúp tố'i ưu hóa quyết định đầu tư</p>
          </div>
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <p>Theo dõi hiệu suất, phân bổ tài sản tố'i ưu, và nhận cảnh báo rủi ro kịp thời</p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>Trợ lý AI cá nhân giúp kiểm soát cảm xúc, duy trì kỷ luật và ra quyết định sáng suố't</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          {loading ? (
            ...
            <div style={{ textAlign: 'center', padding: '40px', color: '#64748b' }}>
              ...
              <div style={{ fontSize: '14px' }}>Hệ thố'ng sẽ tự động tạo tín hiệu mới</div>
            </div>
          ) : (
            <>
              ...
              <div className="strategy-info">
                <div className="strategy-card">
                  ...
                  <div className="strategy-content">
                    ...
                    <p>Hệ thố'ng theo dõi các CP trong danh sách và đưa ra tín hiệu bán theo quy tắc:</p>
                    <ul>
                      <li><strong>Bán 1/2:</strong> Khi giá đạt Take Profit</li>
                      <li><strong>Bán nố't 1/2:</strong> Khi giá cắt xuố'ng MA20 (sau khi đã bán 1/2)</li>
      ...
      {showAuth && (
        <div className="auth-modal">
          ...
          <div className="modal-content">
            ...
            {/* Login type tabs */}
            <div style={{ display: 'flex', marginBottom: '20px', borderRadius: '10px', overflow: 'hidden', border: '1px solid #334155' }}>
              <button type="button" onClick={() => { setIsVipLogin(false); setVipError('') }}
                style={{ flex: 1, padding: '10px', fontSize: '13px', fontWeight: '600',
                  background: !isVipLogin ? '#3b82f6' : 'transparent',
                  color: !isVipLogin ? '#fff' : '#94a3b8', border: 'none', cursor: 'pointer' }}>
                👤 Tài khoản thường
              </button>
              <button type="button" onClick={() => { setIsVipLogin(true); setVipError('') }}
                style={{ flex: 1, padding: '10px', fontSize: '13px', fontWeight: '600',
                  background: isVipLogin ? 'linear-gradient(135deg, #7c3aed, #a855f7)' : 'transparent',
                  color: isVipLogin ? '#fff' : '#94a3b8', border: 'none', cursor: 'pointer' }}>
                💎 Tài khoản VIP
              </button>
            </div>
            ...
            {isVipLogin ? (
              <>
                <div style={{ textAlign: 'center', marginBottom: '16px' }}>
                  ...
                  <h2 style={{ margin: 0, background: 'linear-gradient(135deg, #7c3aed, #a855f7)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>VIP Member</h2>
                  <p style={{ color: '#94a3b8', fontSize: '13px', margin: '4px 0 0' }}>Đăng nhập để truy cập Dashboard VIP</p>
                </div>
                <form className="auth-form" onSubmit={handleVipLogin}>
                  ...
                  {vipError && (
                    <p style={{ color: '#f87171', fontSize: '13px', margin: '-8px 0 12px', textAlign: 'center' }}>
                      ❌ {vipError}
                    </p>
                  )}
                  <button type="submit" disabled={vipLoading} style={{
                    width: '100%', padding: '12px', borderRadius: '10px', border: 'none',
                    background: 'linear-gradient(135deg, #7c3aed, #a855f7)',
                    color: '#fff', fontWeight: '700', fontSize: '15px',
                    cursor: vipLoading ? 'wait' : 'pointer', opacity: vipLoading ? 0.7 : 1,
                  }}>
                    {vipLoading ? '⏳ Đang đăng nhập...' : '💎 Đăng nhập VIP'}
                  </button>
                  <p style={{ color: '#64748b', fontSize: '12px', textAlign: 'center', marginTop: '12px' }}>
                    Chưa có tài khoản VIP? Liên hệ admin để được cấp.
                  </p>
                </form>
              </>
            ) : (
        ...
        <div className="about-modal">
          ...
          <div className="modal-content about-content">
            ...
            <div className="about-header">
              ...
              <h2>Về AI Advisor</h2>
              <p>Hệ thố'ng hỗ trợ ra quyết định đầu tư thông minh</p>
            </div>
            ...
            <div className="about-body">
              <div className="about-section">
                ...
                <p>
                  Hầu hết nhà đầu tư cá nhân — dù có kinh nghiệm — đều từng đố'i mặt với những thách thức sau:
                </p>
                ...
                <div className="about-problems">
                  <div className="about-problem-item">
                    ...
                    <div>
                      <strong>Hành động bố'c đố"ng theo cảm xúc</strong> (FOMO mua đỉnh, hoảng loạn bán đáy)
                    </div>
                  </div>
                  ...
                  <div className="about-problem-item">
                    ...
                    <div>
                      <strong>Không có ai hoặc công cụ nào "nhắc hở dừng lại"</strong> khi hành vi bắt đầu lệch khỏi kế hoạch ban đầu
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="about-section">
                <h3>Hệ thố'ng được thiết kế xoay quanh 3 trụ cột:</h3>
                <div className="about-pillars">
                  <div className="about-pillar-item">
                    <div className="pillar-number-small">1</div>
                    <div className="pillar-content">
                      <h4>Hỗ trợ quyết định</h4>
                      <p>Cung cấp tín hiệu, kịch bản và bố'i cảnh thị trường theo logic nhất quán</p>
                    </div>
                  </div>
                  ...
                  <div className="about-pillar-item">
                    ...
                    <div className="pillar-content">
                      ...
                      <p>Giúp nhà đầu tư tuân thủ kế hoạch đã chọn, thay vì phản ứng bố'c đố"ng theo thị trường</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="about-section">
                <div className="about-vision">
                  ...
                  <p>
                    Xây dựng một trợ lý tài chính AI cá nhân, đóng vai trò như <strong>"bản đố" định hướng"</strong> cho nhà đầu tư — không dẫn đường tắt, không hứa lợi nhuận, nhưng <strong>giúp giảm sai lầm nghiêm trọng và tăng xác suất tố"n tại bền vững trên thị trường.</strong>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="terms-body">
              <div className="terms-section">
                <p className="terms-intro">
                  <strong>AI Advisor là hệ thố'ng hỗ trợ ra quyết định, không phải dịch vụ tư vấn đầu tư, và không đại diện cho bất kỳ tổ chức môi giới hay tài chính nào.</strong>
                </p>
              </div>

              <div className="terms-section">
                <h3>Các nội dung do AI Advisor cung cấp bao gố"m (nhưng không giới hạn):</h3>
              ...
              <div className="terms-section important-notice">
                ...
                <div className="notice-content">
                  ...
                  <p className="highlight">
                    <strong>NgÆ°ời dùng tự chịu hoàn toàn trách nhiệm đố'i với mỗi quyết định mua, bán, nắm giữ tài sản.</strong>
                  </p>
                </div>
              </div>
              ...
              <div className="terms-section">
                <p className="terms-footer-text">
                  Bằng việc sử dụng AI Advisor, bạn xác nhận rằng bạn đã đọc, hiểu và đố"ng ý với các điều khoản miễn trừ trách nhiệm này.
                </p>
              </div>
            </div>
