...
# -*- coding: utf-8 -*-
"""
AI ADVISOR - BACKEND v3.4 - MARKET DASHBOARD CONTEXT
...
def debug_context():
    """DEBUG: Show what context is sent to AI (remove in production)"""
    user_id = request.args.get('user_id', '1')
    try:
        context, signal_tickers = get_portfolio_context(user_id)
        return jsonify({
            'success': True,
            'context_preview': context[:2000],  # First 2000 chars
